...
sched.add_job(send_message_fixed,'cron', day_of_week = 'mon-fri', hour = 12 , minute = 10 , end_date='2020-05-05')
sched.add_job(send_message_fixed,'cron', day_of_week = 'mon-fri', hour = 16 , minute = 15 , end_date='2020-05-05')
sched.start()
